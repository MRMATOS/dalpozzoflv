...
-- Remover constraint se existir e recriar
DO $$ 
BEGIN
    -- Tentar remover constraint se existir
    BEGIN
        ALTER TABLE public.sinonimos_produto DROP CONSTRAINT sinonimos_produto_unique;
    EXCEPTION
    ...
    ADD CONSTRAINT sinonimos_produto_unique 
